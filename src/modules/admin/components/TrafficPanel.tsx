  ...
  return (
    <section className={styles.panel} aria-labelledby="traffic-heading">
      ...
      {disabled && <>
        ...
        <p className={styles.hint}>Traffic collection is off in local development and preview deployments. To opt in on production, configure Supabase, apply the aggregate-traffic migration and enable the server-side analytics flag.</p>
      </>}
      {summary?.enabled && <>
