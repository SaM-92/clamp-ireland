...
export function AdminNav({ current }: { current: "overview" | "moderation" | "published" | "summaries" }) {
  return (
    <nav aria-label="Administration" className={styles.nav}>
      ...
      <Link href="/admin/published" aria-current={current === "published" ? "page" : undefined}>Published reports</Link>
