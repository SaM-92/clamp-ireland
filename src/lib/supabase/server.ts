...
function noStoreFetch(signal?: AbortSignal): typeof fetch {
 ...
 */
export function createServiceRoleClient(signal?: AbortSignal): SupabaseClient {
  ...
  return createClient(env.NEXT_PUBLIC_SUPABASE_URL, env.SUPABASE_SERVICE_ROLE_KEY, {
    ...
    global: { fetch: noStoreFetch(signal) },
  });
}
 ...
 */
export function createAnonServerClient(signal?: AbortSignal): SupabaseClient {
...
export async function getUserFromRequest(
  ...
  const supabase = createAnonServerClient(signal);
